 ...
 * 
 */
define('bii_global_class_version', '2.4.3');
...
//		echo $req;
	...
	static function displaySousMenu($role = 'bii_access_plugin', $hide_edit = true) {
